	...
	<div class="wrap_event">
		...
		<main>
			<div class="section">
				...
				<ul class="menu_area">
					<li><a href="/nongra/event/scheduled?pno=1" class="active menu_list">진행예정 이벤트
					...
					<li><a href="/nongra/event/list?pno=1" class="menu_list">진행중인 이벤트
			...
			<div class="content_area">
				<div class="board_name">진행예정 이벤트</div>
					<ul class="event_ul">
					...
					<div class="page_list_event">
						<div class="page_num_event">
							<% if(pvo.getStartPage() != 1){ %>
								<a href="/nongra/event/scheduled?pno=<%=pvo.getStartPage()-1 %>"> < </a>
							<% } %>
							<% for(int i = pvo.getStartPage(); i <= pvo.getEndPage(); i++){ %>
									<a href="/nongra/event/scheduled?pno=<%=i %>" class="page_on"><%=i %></a>
							<% } %>
							<% if(pvo.getEndPage() != pvo.getMaxPage()){ %>
								<a href="/nongra/event/scheduled?pno=<%=pvo.getEndPage()+1 %>"> > </a>
							<% } %>
						</div>
					</div>
				</div>
