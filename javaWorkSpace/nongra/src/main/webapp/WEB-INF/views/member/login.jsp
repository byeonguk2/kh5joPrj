...
<link rel="stylesheet" href="/nongra/resources/css/login/memberLogin.css">
</head>
<body>
	<div id="root">
        <div class="css-auhedv">
            ...
            <div>
                ...
                <div>
                    <a class="" href="/nongra/id/find">아이디 찾기</a>
                    <span>|</span>
                    <a class="" href="/nongra/pwd/find">비밀번호 찾기</a>
                    <span>|</span>
                    <a class="" href="/nongra/member/join">회원 가입</a>
                </div>
            </div>
            <p>회원 계정의 보안을 위해 24시간을 기준으로 2단계 인증을 적용합니다.<br>인증로그인 후 24시간(동일IP) 이내는 2단계 인증없이 로그인 가능합니다.</p>
        </div>
    </div>
</body>
</html>
