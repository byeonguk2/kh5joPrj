...
public class EventListController extends HttpServlet{
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		try {
			...
			int listCount = es.selectPresentEventCount();
			...
			List<EventVo> eventVoList = es.selectPresentEventList(pvo);
			...
			System.out.println("[EVENT-E001] 이벤트 목록조회 중 에러 발생");
			e.printStackTrace();
