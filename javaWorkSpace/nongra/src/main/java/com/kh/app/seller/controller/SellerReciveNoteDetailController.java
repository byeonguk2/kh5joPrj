...
@WebServlet("/seller/recive/note/detail")
public class SellerReciveNoteDetailController extends HttpServlet{
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		try {
			...
			req.getRequestDispatcher("/WEB-INF/views/seller/note/reciveNoteDetail.jsp").forward(req, resp);
		}catch(Exception e) {
			e.printStackTrace();
